...
# 安排
- 每周两次线下的 Live Coding Session，每次两小时，具体地点和时间请密切留意我们的[课表](https://paulcccccch.github.io/m5-201)。
- 在参加线下 Live Coding Session 之前，建议先把[课表](https://paulcccccch.github.io/m5-201)上的内容先过一遍，尽量多地搞懂。
...
具体的内容请查询[课表](https://paulcccccch.github.io/m5-201)。
