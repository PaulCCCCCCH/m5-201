 ...
 * -----
 * Last Modified: Friday, 19th March 2021 8:24:35 pm
 * Modified By: <<authore>> (paulcccccch@gmail.com)
 * -----
...
function fall() {
	/*
		...
		请完成这个函数里所有的下落逻辑。
		提示：可以先完成 downValid 这个函数，来判断方块下落是否到底
	*/
